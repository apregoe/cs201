...
public class FactoryStockPersons extends FactoryWorker {
    ...
    protected Resource mProductToStock;

    public FactoryStockPersons(int inNumber, FactoryNode startNode, FactorySimulation inFactorySimulation) {
        ...
        try{
            while(true){
                if(mProductToStock == null){
                    ...
                    mProductToStock = mFactorySimulation.getmMailbox().getStock();
